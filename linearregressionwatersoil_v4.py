...
#Decision Tree
raw_dataset = pd.read_csv("./input/baseagrimoins12hswvl1_moins2jswvl2.csv")
...
# sns_hist=sns.heatmap(corrs, cmap = plt.cm.RdYlBu_r, vmin = -0.5, annot = True, vmax = 1)
# plt.title('Correlation Heatmap');
# #plt.show()
# sns_plot = sns_hist.get_figure()
# sns_plot.savefig("output2_heatmap.png")

# plt.figure(figsize = (12,8))
# target = np.log(train_dataset['swvl1'])
# target.skew()
...
# plt.subplot(3,3,1)
# sns.boxplot(x = 'swvl1', y = 'd2m', data = train_dataset)
# plt.subplot(3,3,2)
# sns.boxplot(x = 'evabs', y = 'tp', data = train_dataset)
# plt.subplot(3,3,3)
# sns.boxplot(x = 'sshf', y = 't2m', data = train_dataset)
# plt.subplot(3,3,4)
# sns.boxplot(x = 'swvl2', y = 'evabs', data = train_dataset)
# plt.subplot(3,3,5)
# sns.boxplot(x = 't2m', y = 'v10', data = train_dataset)
# plt.subplot(3,3,6)
# sns.boxplot(x = 'swvl1', y = 'sshf', data = train_dataset)
# plt.subplot(3,3,7)
# sns.boxplot(x = 'swvl1', y = 'u10', data = train_dataset)
# plt.subplot(3,3,8)
# sns.boxplot(x = 'd2m', y = 'sp', data = train_dataset)
# plt.subplot(3,3,9)
# sns.boxplot(x = 'sshf', y = 'd2m', data = train_dataset)
# plt.show()

# y = train_dataset['swvl1']
...
#Compute R-Square value for validation set
#ValR2Value = r2_score(test_labels[LlimReal:UlimReal],test_predictions[LlimPred:UlimPred])
#ValR2Value = r2_score(test_labels2[LlimReal:2000],test_predictions2[LlimPred:2000])
